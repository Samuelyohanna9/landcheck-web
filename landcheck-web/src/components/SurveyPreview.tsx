...
function SurveyPreview({
  ...
  // Reset to fit-page baseline when preview source changes.
  useEffect(() => {
    setPosition({ x: 0, y: 0 });
    setZoom(100);
        ...
        <div className="topo-source-bar">
          ...
          <div className="topo-source-toggle">
            ...
            <button
              ...
              title={hasHeightData ? "" : "Upload a CSV with a height/elevation column to use your own data."}
            >
              <svg viewBox="0 0 20 20" fill="currentColor" style={{ width: 14, height: 14 }}>
                <path fillRule="evenodd" d="M3 17a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM6.293 6.707a1 1 0 010-1.414l3-3a1 1 0 011.414 0l3 3a1 1 0 01-1.414 1.414L11 5.414V13a1 1 0 11-2 0V5.414L7.707 6.707a1 1 0 01-1.414 0z" clipRule="evenodd" />
              </svg>
              Your Data
              {!hasHeightData && <span className="no-data-badge">No data yet</span>}
            </button>
          </div>
